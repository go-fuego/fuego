...
func TestServer_generateOpenAPI(t *testing.T) {
	...
	// require.NotNil(t, document.Paths.PathItems.GetOrZero("/"))
	// require.Nil(t, document.Paths.PathItems.GetOrZero("/unknown"))
	// require.NotNil(t, document.Paths.PathItems.GetOrZero("/post"))
	// require.NotNil(t, document.Model.Paths.PathItems.GetOrZero("/post/{id}").Get.Responses.Value("200"))
	// require.NotNil(t, document.Model.Paths.PathItems.GetOrZero("/post/{id}").Get.Responses.Value("200").Value.Content["application/json"])
	// require.Nil(t, document.Model.Paths.PathItems.GetOrZero("/post/{id}").Get.Responses.Value("200").Value.Content["application/json"].Schema.Value.Properties["unknown"])
	// require.Equal(t, document.Model.Paths.PathItems.GetOrZero("/post/{id}").Get.Responses.Value("200").Value.Content["application/json"].Schema.Value.Properties["quantity"].Value.Type, "integer")
