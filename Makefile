...
integration:
	make example > server.logs & sleep 3 && HURL_GOURMET_BASE_URL=http://localhost:8083 HURL_GOURMET_BASIC_AUTH="YWRtaW46YWRtaW4=" hurl -v --test integration-tests ; kill $(lsof -ti:8083)
